...
% 	\legend{Fonte: \space\citeonline{aplicacoes_ia_vg}}
% 	\label{fig:areas_ia}
% \end{figure}
...
\begin{figure}[ht]
	...
	\legend{Fonte: DALL·E \space\citeonline{OpenAI2021}}
	\label{fig:ia_concept}
\end{figure}

% Segundo \space\citeonline{dp_overview} existem três principais tópicos sobre inteligência artificial, sendo eles: inteligência artificial, aprendizado de máquina e aprendizado profundo como mostrado na \cref{fig:diagrama_ia_ml_dp}.
