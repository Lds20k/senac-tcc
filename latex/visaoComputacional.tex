...
\begin{figure}[ht]
    ...
    \begin{minipage}[H]{0.49\textwidth}
      ...
      \includegraphics[width=0.6\textwidth]{figures/detectacao_de_faces_exemplo.JPG}
	    \legend{Fonte: \space\citeonline{computer_vision_richard}}
      \label{fig:imagem_a}
    \end{minipage}
    \hfill
    \begin{minipage}[H]{0.49\textwidth}
      ...
      \includegraphics[width=0.6\textwidth]{figures/semantic_intance.JPG}
	    \legend{Fonte: \space\citeonline{instance_segmentation}}
      \label{fig:imagem_b}
    \end{minipage}
  \end{figure}
...
\begin{figure}[ht]
	...
	\legend{Fonte: \space\citeonline{content_Human_Vision}}
  \label{fig:comp_vision}
\end{figure}
