...
A seguir um exemplo dos passos para construir a matriz resultante baseado em \space\citeonline{Alzubaidi2021}.
...
Existem vários tipos de agrupamento, os mais utilizados são: agrupamento máximo, agrupamento médio e agrupamento global médio que estão explicados abaixo em exemplos baseados em \space\citeonline{Alzubaidi2021}.
...
Segundo \space\citeonline{Alzubaidi2021, computation11030052} existem algumas técnicas para aperfeiçoar os resultados do modelo, sendo elas:
