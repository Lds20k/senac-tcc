...
Com base em testes de aplicações do trabalho \citeonline{Alzubaidi2021} existem algumas maneiras de melhorar a qualidade do resultado final do modelo sendo elas:
