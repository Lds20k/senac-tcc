...
% Aplicando um filtro — ou kernel — de tamanho 100x100 obteve-se o resultado ilustrado na \cref{fig:unity_blur}. Porém se analisar a \cref{} pode-se observar que o resultado baseado em métricas que mensuram a qualidade da geração procedural baseando-se no contorno das duas imagens. Na \cref{} observa-se uma representação visual dos conjuntos definidos no \hyperref[sec:classificacao_conjuntos]{sub tópico} usados nas métricas.
