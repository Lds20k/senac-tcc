...
Utilizou-se o código aberto oficial do trabalho cientifico postado no repositório do Github de \citeonline{efficientpsGit} que foi baseado no tópico \hyperref[sec:EfficientPS]{EfficientPS}.
...
Seguiu-se os passos citados numa publicação de \citeonline{efficientps_issue23} no repositório de \citeonline{efficientpsGit} porém o resultado obtido não foi satisfatório pois não possível discernir quais segmentos pertenciam as respectivas classes, o resultado é ilustrado na \cref{fig:resultado_obtido}.
