...
Utilizou-se o modelo EfficientPS que segundo \citeonline{mohan2020efficientps} é uma solução eficiente para a segmentação panóptica. E também o código postado no repositório de \citeonline{efficientpsGit}.
...
De acordo com \citeonline{Embarcados}, após a saída dos algoritmos de seleção, o objeto selecionado é detectado e centralizado em uma nova imagem, depois recortamos e redimensionamos a partir do centro de forma que fique quadrada. Todos os passos são observáveis na \cref{fig:saidas_selecao}.
...
Depois foi contabilizado esses pixeis com cores diferentes para utilizar em diversas métricas baseadas na classificação dos conjuntos, sendo elas: F1 Score, Coeficiente de correlação de Matthews, Taxa de descoberta falsa, Taxa de Falso Negativo, Acurácia, União sobre intersecção, Qualidade panóptica \cite{Chicco2020, confusion_matrix_calculator, iou_metric_link}.
