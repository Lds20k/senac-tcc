...
EfficientPS é uma solução eficiente para a segmentação panóptica proposta no artigo \citeonline{mohan2020efficientps}. E em seu repositório na internet de \citeonline{efficientpsGit} possui algumas recomendações de tecnologias, que são as que foram usadas para fazer e testar o modelo, logo poderá funcionar em outros cenários porém sem suporte dos criadores. Essas tecnologias são: uma distribuição de sistema operacional \footnote{Programa que gerencia a parte física de um computador; Meio termo entre o usuário e a parte física do computador} com núcleo Linux de acordo com \citeonline{redhat2023}, a linguagem de programação Python na versão 3.7 que de acordo com \citeonline{analyticsindiamag2023} é amplamente utilizada para o ramo de IA devido a simplicidade e diversas bibliotecas que facilitam a criação de modelos complexos, o PyTorch na versão 1.7 que de acordo com \citeonline{pytorch2023} é uma estrutura baseada na biblioteca Torch que visa facilitar a criação de modelos de aprendizado profundo, CUDA Toolkit na versão 10.2 que de acordo com \citeonline{cudatoolkit2023} é uma biblioteca para proporcionar aceleração do processamento com placas de vídeo da marca Nvidia e por fim GCC na versão 7 ou 8 que de acordo com \citeonline{gcc2023} é um compilador da linguagem C e C++ que geralmente são utilizados em bibliotecas Python como por exemplo PyTorch.
