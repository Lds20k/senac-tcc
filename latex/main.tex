...
Com o crescente desenvolvimento de diversas inteligencias artificiais(IA), se faz necessário entender os fundamentos e a como poder utiliza-la em conjunto dos mais variados tipos de algoritmos.

Fazendo a aplicação do algoritmo de geração de mapas procedurais trará uma base introdutória sobre o funcionamento de algoritmos que utilizam ruídos para gerar padrões, juntando isso a visão computacional trará uma de suas aplicações, \emph{e. g.} utilizar em reflorestamento de matas nativas.
