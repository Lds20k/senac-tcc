...
A principal diferença entre uma rede neural convencional e uma rede neural profunda é o fato de possuir mais camadas \cite{marti2017aprendizado}.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{figures/redes_neurais.png}
	\caption{Comparação de uma rede neural convencional com uma rede neural profunda \cite{aplicacoes_ia_vg}.}	
