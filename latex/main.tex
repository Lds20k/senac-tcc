...
\newacro{IA}{Inteligencia Artificial}
...
Por outro lado as fabricantes de jogos digitais desenvolvem sem parar para suprir o público de jogadores que em 2022 cresceu 2,5\% no Brasil (PGB - 2022), só que para um jogo chegar ao consumidor final é passado por diversos processos de criação, que são extremamente complexos e rígidos, uma vez que uma equipe de desenvolvimento com designers e programadores tem que mover muita das suas forças para elaboração de mapas 2D e 3D, afim de deixar o jogo com a melhor aparência e mais optimizado possível.
