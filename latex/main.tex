...
Contudo, este trabalho tem como objetivo geral explorar técnicas e algoritmos que permeam os ramos de inteligência artificial com foco em identificar contornos em imgens e computação gráfica centrado em gerar mapas usando heurísticas.
Ademais visto especificamente temos como objetivos:

- Reunir artigos relacionados com os temas

- Achar um dataset que se encaixe no trabalho

- Treinar uma inteligência artificial para identificar contornos em imagens

- Programar a heirística para gerar o mapa 


\chapter{Fundamentação teórica}
\label{sec:background}s
