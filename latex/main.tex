...
Uma rede neural convolucional é analoga a rede neural artificial i.e. feita de neurônios que otimizam o aprendizado através dele mesmo. A principal diferença é que a rede neural convolucional é amplamente utilizada em soluções que detectam padrões em imagens, logo existem funcionaliidades específicas da própria arquitetura para essa tarefa \cite{oshea2015introduction}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/fluxo_cnn.png}
	\caption{Etapas básicas de uma rede neural convolucional \cite{computation11030052}.}	
	\label{fig:fluxo_cnn}
\end{figure}
