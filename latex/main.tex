...
Segundo \cite{directions_ia_ml_dp}, aprendizado de máquina é uma subcategoria de inteligência artificial que refere-se a detecção de padrões importantes de uma base de dados. As ferramentas utilizadas aumentam a eficiência dos algoritmos para lidar com bases de dados grandes.
...
Existe relação direta de conceitos entre inteligência artificial, aprendizado de máquina e ciência de dados conforme mostrado na Figura 2. 
\begin{figure}[!ht]
	\centering
...
O conceito de visão computacional tem como base ensinar um computador a ver e entender o conteúdo de uma imagem, assim, permite com que o computador identifique as coisas ao seu redor, deixando a visão do computador semelhante com a de um humano.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/content_Human_Vision.jpg}
...
Palmeiras
\subsubsection{Aplicações de visão computacional}
Palmeiras
